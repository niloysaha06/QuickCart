        ...
        <div className='bg-slate-200'>
          <div className='container px-12 pb-8'>
            <div className='row pt-10'>
                <div>
                    <h1 className='text-3xl font-medium text-black pb-4'>Checkout</h1>
                </div>
                  <div className='col-sm-8'>
                      
                      <div className='bg-white py-8 shadow space-y-1 rounded-lg'>
                          <p className='text-xl text-start pl-4'>Shipping Information</p>
                          <p className='text-md text-start pl-4'>+Add new address</p>
                      </div>

                      <div className='bg-rose mt-10'>
