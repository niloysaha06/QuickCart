...
const Login = () => {
    return (
      ...
      <div
        class="flex flex-col overflow-hidden bg-white rounded-md shadow-lg max md:flex-row md:flex-1 lg:max-w-screen-sm"
      >
        {/* <div
          class="p-4 py-6 text-white bg-white md:w-60 md:flex-shrink-0 md:flex md:flex-col md:items-center md:justify-evenly"
        >
        ...
        <div class="p-5 bg-white md:flex-1">
          ...
          <form action="#" class="flex flex-col space-y-5">
            <div class="flex flex-col space-y-1">
              <label for="email" class="text-sm font-semibold text-gray-500 text-left">Email address</label>
              <input
                type="email"
                id="email"
                autofocus
