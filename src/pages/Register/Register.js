...
const Register = () => {
    return (
        ...
        >
          {/* <div
            class="p-4 py-6 text-white bg-white md:w-65 md:flex-shrink-0 md:flex md:flex-col md:items-center md:justify-evenly"
          >
          ...
          <div class="p-5 bg-white md:flex-1">
            ...
            <div class="flex flex-col space-y-1">
                <div class="flex items-center justify-between">
                  <label for="number" class="text-sm font-semibold text-gray-500">Phone Number</label>
